...
/*
Além de apresentar os dados, o SELECT permite manipular os dados para a apresentação
*/			  
...
-- Mas essa regra deve ser evitada e em certos casos (como CTE, views e subconsultas)
...
Select Contato, Cargo, Endereco, Cidade , CEP, Pais , Telefone, Fax
  From Vendas.Cliente
